...
class MIPSteelProfileWall(BaseWall):
    """ Concrete class for pile walls"""
    def __init__(self, wall_area=3430.0, wall_thickness=0.55, productivity=170.0, cement=430.0, betonite=15.0, weight_steelprofile=270.0, 
